...
function startNode0() {
    log('Toogle Node 0'); //mit dem sehen wir jedesmal die Uhrzeit wenn wer draufgedrückt hat
...
function log(text) {
    let hours = ('0' + new Date().getHours()).slice(-2); //Funtkion für Uhrzeit
    let minutes = ('0' + new Date().getMinutes()).slice(-2);
    logs.innerHTML += `
 <div class="mb-16"><code>
